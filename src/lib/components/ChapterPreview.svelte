    ...
    <div class="chapter-container">
        <ul>
            <li>
                ...
                aria-expanded="true"><h3>Chapter 1: Navigating the Spanish Bureaucracy</h3></button>
            </li>
        </ul>
        <div class="chapter-info">
            <h3 class="chapter-strapline italic mb-s">Understanding Visas, Residency, and Legal Essentials</h3>
            <p>
